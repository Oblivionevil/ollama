...
[Ollama](https://ollama.com) in this repository is the Windows desktop app for getting up and running with large language models such as gpt-oss, Gemma 3, DeepSeek-R1, Qwen3 and more.

<CardGroup cols={2}>
  <Card title="Quickstart" icon="rocket" href="/quickstart">
    Get up and running with your first chat or call the local API
  </Card>
  <Card
