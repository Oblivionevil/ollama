...
Ollama's cloud models require an account on [ollama.com](https://ollama.com). To sign in or create an account, open the Windows app, go to Settings, and complete the sign-in flow.

<Tabs>
  <Tab title="Python">

Install [Ollama's Python library](https://github.com/ollama/ollama-python):

```
pip install ollama
```

Then create and run a simple Python script:
...
Install [Ollama's JavaScript library](https://github.com/ollama/ollama-js):
...
Run the following cURL command via Ollama's local API:
